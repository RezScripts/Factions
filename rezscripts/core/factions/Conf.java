...
import rezscripts.core.factions.integration.dynmap.DynmapStyle;
...
public class Conf {
	...
	public static String factionChatPrefix = ChatColor.translateAlternateColorCodes('&', "&2[&a&lFaction&r&2]&r");
	public static String allyChatPrefix = ChatColor.translateAlternateColorCodes('&', "&5[&d&lAlly&r&5]&r");
	public static String truceChatPrefix = ChatColor.translateAlternateColorCodes('&', "&9[&b&lTruce&r&9]&r");
	public static String enemyChatPrefix = ChatColor.translateAlternateColorCodes('&', "&4[&c&lEnemy&r&4]&r");
    ...
    public static double powerPlayerStarting = 5.0;
    public static double powerPerMinute = 1; // Default health rate... it takes 5 min to heal one power
    public static double powerPerDeath = 2.0; // A death makes you lose 4 power
    ...
    public static int factionMemberLimit = 20;
    ...
    public static String factionChatFormat = factionChatPrefix + ChatColor.GREEN + " %s:" + ChatColor.GREEN + " %s";
    public static String allianceChatFormat = allyChatPrefix + ChatColor.LIGHT_PURPLE + " %s:" + ChatColor.LIGHT_PURPLE + " %s";
    public static String truceChatFormat = truceChatPrefix + ChatColor.AQUA + " %s:" + ChatColor.AQUA + " %s";
    public static String enemyChatFormat = enemyChatPrefix + ChatColor.RED + " %s:" + ChatColor.RED + " %s";
    ...
    public static boolean peacefulTerritoryDisableMonsters = true;
    public static boolean peacefulTerritoryDisableBoom = true;
