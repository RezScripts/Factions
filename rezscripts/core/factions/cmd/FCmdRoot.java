...
public class FCmdRoot extends FCommand {
    ...
    public CmdStartKoth cmdStartKoth = new CmdStartKoth();
    public CmdGive cmdGive = new CmdGive();
//    public CmdKoth cmdKoth = new CmdKoth();
    ...
    public CmdRelationTruce cmdTruce = new CmdRelationTruce();
    ...
    public FCmdRoot() {
        ...
        this.addSubCommand(this.cmdStartKoth);
        this.addSubCommand(this.cmdAdmin);
        this.addSubCommand(this.cmdGive);
        this.addSubCommand(this.cmdTruce);
