package rezscripts.core.factions.zcore.util;
...
public enum TagReplacer {
    ...
    TRUCE_LIST(TagType.FANCY, "{truce-list}"),
    ...
    KOTH_WINS(TagType.FACTION, "{koth-wins}"),
    ...
    TOTAL_VALUE(TagType.FACTION, "{total-value}"),
    BALANCE_VALUE(TagType.FACTION, "{balance-value}"),
    ...
    protected String getValue(Faction fac, FPlayer fp) {
        ...
        switch (this) {
            ...
            case LAND_VALUE:
                return Econ.shouldBeUsed() ? Econ.moneyString(Econ.calculateTotalLandValue(fac)) : minimal ? null : TL.ECON_OFF.format("value");
            case LAND_REFUND:
            ...
            case BALANCE_VALUE:
            	return Econ.moneyString(Econ.calculateBalanceValue(fac));
            case TOTAL_VALUE:
            	return Econ.moneyString(Econ.calculateTotalValue(fac));
            case KOTH_WINS:
            	return fac.getKothWins() + "";
            case BANK_BALANCE:
