...
public enum TL {
    ...
    COMMAND_GIVE_DESCRIPTION("Spawn core items command."),
    ...
    COMMAND_CHAT_INVALIDMODE("<b>Unrecognised chat mode. <i>Please enter either 'a','f', 'p' or 'e'"),
    ...
    COMMAND_CHAT_MODE_ENEMY("<i>Enemy only chat mode."),
    ...
    COMMAND_UPGRADE_DESCRIPTION("Show upgrade path for your faction"),
    COMMAND_UPGRADE_NEEDADMIN("You need to be an admin in your faction to upgrade it!"),
