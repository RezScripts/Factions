...
public class FLocation implements Serializable {
    ...
    public Location getLocation() {
    	return new Location(getWorld(), getX()*16, 0, getZ()*16);
    }
    ...
    public boolean isOutsideWorldBorder(int buffer) {
        ...
        WorldBorder border = (WorldBorder) getWorld().getWorldBorder();
        Chunk chunk = ((org.bukkit.WorldBorder) border).getCenter().getChunk();

        int lim = FLocation.chunkToRegion((int) ((org.bukkit.WorldBorder) border).getSize()) - buffer;
